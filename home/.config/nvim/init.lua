...
vim.keymap.set("n", "<Leader>H", "zt", { noremap = true })
vim.keymap.set("n", "<Leader>J", "G", { noremap = true })
vim.keymap.set("n", "<Leader>K", "gg", { noremap = true })
vim.keymap.set("n", "<Leader>L", "zb", { noremap = true })
...
vim.keymap.set("n", "<Leader>c", "zz", { noremap = true })
